...
module soc_system_mm_interconnect_2 (
		...
		output wire [1:0]  VersionID_s1_address,                                                //                                                  VersionID_s1.address
		input  wire [31:0] VersionID_s1_readdata                                                //                                                              .readdata
	);
	...
	wire   [31:0] versionid_s1_agent_m0_readdata;                           // VersionID_s1_translator:uav_readdata -> VersionID_s1_agent:m0_readdata
	wire          versionid_s1_agent_m0_waitrequest;                        // VersionID_s1_translator:uav_waitrequest -> VersionID_s1_agent:m0_waitrequest
	wire          versionid_s1_agent_m0_debugaccess;                        // VersionID_s1_agent:m0_debugaccess -> VersionID_s1_translator:uav_debugaccess
	wire   [20:0] versionid_s1_agent_m0_address;                            // VersionID_s1_agent:m0_address -> VersionID_s1_translator:uav_address
	wire    [3:0] versionid_s1_agent_m0_byteenable;                         // VersionID_s1_agent:m0_byteenable -> VersionID_s1_translator:uav_byteenable
	wire          versionid_s1_agent_m0_read;                               // VersionID_s1_agent:m0_read -> VersionID_s1_translator:uav_read
	wire          versionid_s1_agent_m0_readdatavalid;                      // VersionID_s1_translator:uav_readdatavalid -> VersionID_s1_agent:m0_readdatavalid
	wire          versionid_s1_agent_m0_lock;                               // VersionID_s1_agent:m0_lock -> VersionID_s1_translator:uav_lock
	wire   [31:0] versionid_s1_agent_m0_writedata;                          // VersionID_s1_agent:m0_writedata -> VersionID_s1_translator:uav_writedata
	wire          versionid_s1_agent_m0_write;                              // VersionID_s1_agent:m0_write -> VersionID_s1_translator:uav_write
	wire    [2:0] versionid_s1_agent_m0_burstcount;                         // VersionID_s1_agent:m0_burstcount -> VersionID_s1_translator:uav_burstcount
	wire          versionid_s1_agent_rf_source_valid;                       // VersionID_s1_agent:rf_source_valid -> VersionID_s1_agent_rsp_fifo:in_valid
	wire  [114:0] versionid_s1_agent_rf_source_data;                        // VersionID_s1_agent:rf_source_data -> VersionID_s1_agent_rsp_fifo:in_data
	wire          versionid_s1_agent_rf_source_ready;                       // VersionID_s1_agent_rsp_fifo:in_ready -> VersionID_s1_agent:rf_source_ready
	wire          versionid_s1_agent_rf_source_startofpacket;               // VersionID_s1_agent:rf_source_startofpacket -> VersionID_s1_agent_rsp_fifo:in_startofpacket
	wire          versionid_s1_agent_rf_source_endofpacket;                 // VersionID_s1_agent:rf_source_endofpacket -> VersionID_s1_agent_rsp_fifo:in_endofpacket
	wire          versionid_s1_agent_rsp_fifo_out_valid;                    // VersionID_s1_agent_rsp_fifo:out_valid -> VersionID_s1_agent:rf_sink_valid
	wire  [114:0] versionid_s1_agent_rsp_fifo_out_data;                     // VersionID_s1_agent_rsp_fifo:out_data -> VersionID_s1_agent:rf_sink_data
	wire          versionid_s1_agent_rsp_fifo_out_ready;                    // VersionID_s1_agent:rf_sink_ready -> VersionID_s1_agent_rsp_fifo:out_ready
	wire          versionid_s1_agent_rsp_fifo_out_startofpacket;            // VersionID_s1_agent_rsp_fifo:out_startofpacket -> VersionID_s1_agent:rf_sink_startofpacket
	wire          versionid_s1_agent_rsp_fifo_out_endofpacket;              // VersionID_s1_agent_rsp_fifo:out_endofpacket -> VersionID_s1_agent:rf_sink_endofpacket
	wire          versionid_s1_agent_rdata_fifo_src_valid;                  // VersionID_s1_agent:rdata_fifo_src_valid -> VersionID_s1_agent_rdata_fifo:in_valid
	wire   [33:0] versionid_s1_agent_rdata_fifo_src_data;                   // VersionID_s1_agent:rdata_fifo_src_data -> VersionID_s1_agent_rdata_fifo:in_data
	wire          versionid_s1_agent_rdata_fifo_src_ready;                  // VersionID_s1_agent_rdata_fifo:in_ready -> VersionID_s1_agent:rdata_fifo_src_ready
	...
	wire          versionid_s1_agent_rp_valid;                              // VersionID_s1_agent:rp_valid -> router_005:sink_valid
	wire  [113:0] versionid_s1_agent_rp_data;                               // VersionID_s1_agent:rp_data -> router_005:sink_data
	wire          versionid_s1_agent_rp_ready;                              // router_005:sink_ready -> VersionID_s1_agent:rp_ready
	wire          versionid_s1_agent_rp_startofpacket;                      // VersionID_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          versionid_s1_agent_rp_endofpacket;                        // VersionID_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                    // cmd_mux_003:src_valid -> VersionID_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_003_src_data;                                     // cmd_mux_003:src_data -> VersionID_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                    // VersionID_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                  // cmd_mux_003:src_channel -> VersionID_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                            // cmd_mux_003:src_startofpacket -> VersionID_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                              // cmd_mux_003:src_endofpacket -> VersionID_s1_burst_adapter:sink0_endofpacket
	wire          versionid_s1_burst_adapter_source0_valid;                 // VersionID_s1_burst_adapter:source0_valid -> VersionID_s1_agent:cp_valid
	wire  [113:0] versionid_s1_burst_adapter_source0_data;                  // VersionID_s1_burst_adapter:source0_data -> VersionID_s1_agent:cp_data
	wire          versionid_s1_burst_adapter_source0_ready;                 // VersionID_s1_agent:cp_ready -> VersionID_s1_burst_adapter:source0_ready
	wire    [3:0] versionid_s1_burst_adapter_source0_channel;               // VersionID_s1_burst_adapter:source0_channel -> VersionID_s1_agent:cp_channel
	wire          versionid_s1_burst_adapter_source0_startofpacket;         // VersionID_s1_burst_adapter:source0_startofpacket -> VersionID_s1_agent:cp_startofpacket
	wire          versionid_s1_burst_adapter_source0_endofpacket;           // VersionID_s1_burst_adapter:source0_endofpacket -> VersionID_s1_agent:cp_endofpacket
	...
	wire          versionid_s1_agent_rdata_fifo_out_valid;                  // VersionID_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] versionid_s1_agent_rdata_fifo_out_data;                   // VersionID_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          versionid_s1_agent_rdata_fifo_out_ready;                  // avalon_st_adapter_003:in_0_ready -> VersionID_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                        // avalon_st_adapter_003:out_0_valid -> VersionID_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                         // avalon_st_adapter_003:out_0_data -> VersionID_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                        // VersionID_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                        // avalon_st_adapter_003:out_0_error -> VersionID_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) versionid_s1_translator (
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (led_pio_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (versionid_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (versionid_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (versionid_s1_agent_m0_read),                //                         .read
		.uav_write              (versionid_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (versionid_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (versionid_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (versionid_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (versionid_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (versionid_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (versionid_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (versionid_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (VersionID_s1_address),                      //      avalon_anti_slave_0.address
		.av_readdata            (VersionID_s1_readdata),                     //                         .readdata
		.av_write               (),                                          //              (terminated)
		.av_read                (),                                          //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (led_pio_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (versionid_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (versionid_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (versionid_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (versionid_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (versionid_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (versionid_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (versionid_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (versionid_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (versionid_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (versionid_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (versionid_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (versionid_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (versionid_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (versionid_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (versionid_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (versionid_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (versionid_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (versionid_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (versionid_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (versionid_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (versionid_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (versionid_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (versionid_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (versionid_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (versionid_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (versionid_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (versionid_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (versionid_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (versionid_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (versionid_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (versionid_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (versionid_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                //                .error
		.rdata_fifo_src_ready    (versionid_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (versionid_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (versionid_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) versionid_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (led_pio_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (versionid_s1_agent_rf_source_data),             //        in.data
		.in_valid          (versionid_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (versionid_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (versionid_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (versionid_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (versionid_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (versionid_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (versionid_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (versionid_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (versionid_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) versionid_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                             //       clk.clk
		.reset             (led_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (versionid_s1_agent_rdata_fifo_src_data),    //        in.data
		.in_valid          (versionid_s1_agent_rdata_fifo_src_valid),   //          .valid
		.in_ready          (versionid_s1_agent_rdata_fifo_src_ready),   //          .ready
		.out_data          (versionid_s1_agent_rdata_fifo_out_data),    //       out.data
		.out_valid         (versionid_s1_agent_rdata_fifo_out_valid),   //          .valid
		.out_ready         (versionid_s1_agent_rdata_fifo_out_ready),   //          .ready
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	soc_system_mm_interconnect_2_router_002 router_005 (
		.sink_ready         (versionid_s1_agent_rp_ready),               //      sink.ready
		.sink_valid         (versionid_s1_agent_rp_valid),               //          .valid
		.sink_data          (versionid_s1_agent_rp_data),                //          .data
		.sink_startofpacket (versionid_s1_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (versionid_s1_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (led_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (versionid_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (versionid_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (versionid_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (versionid_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (versionid_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (versionid_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_1_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (led_pio_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (versionid_s1_agent_rdata_fifo_out_data),    //     in_0.data
		.in_0_valid     (versionid_s1_agent_rdata_fifo_out_valid),   //         .valid
		.in_0_ready     (versionid_s1_agent_rdata_fifo_out_ready),   //         .ready
